...
// Problem 1
const edus = runners.filter(function(runner) {
  return runner.email.includes(".edu") || runner.email.includes("intel.com");
})

console.log(edus);

// Problem 2
const cheap = runners.filter(function(runner) {
  return runner.donation < 50;
})

console.log(cheap);
// Problem 3
const total = runners.reduce(function(base, runner) {
  return base + runner.donation
}, 0)

const average = total / runners.length;
